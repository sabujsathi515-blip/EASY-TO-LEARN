    ...
    >
      ...
      <div className="bg-slate-900 text-white border-b border-slate-800 px-4 py-3 flex flex-wrap items-center justify-between gap-3 shadow-md">
        ...
        <div className="flex items-center gap-2">
          ...
          {/* Conditional Download Button if permitted by Admin */}
          {activeDocument.allowDownload && activeDocument.fileUrl && (
            <a
              href={activeDocument.fileUrl}
              download={activeDocument.fileName || `${activeDocument.title}.pdf`}
              target="_blank"
              ...
              title="Download Authorized Material"
            >
      ...
      <div className="bg-slate-900 border-b border-slate-800 px-4 py-2 flex flex-wrap items-center justify-between gap-2 text-xs">
        <div className="flex items-center gap-2 font-medium">
          {activeDocument.allowDownload ? (
            <span className="bg-emerald-600 text-white px-2.5 py-0.5 rounded text-[11px] font-bold uppercase tracking-wider shadow-xs">
              DOWNLOAD PERMITTED BY TEACHER
            </span>
          ) : (
          ...
          <span className="hidden md:inline text-slate-300">
            {activeDocument.allowDownload
              ? '• Official study material • Download permitted for enrolled students'
