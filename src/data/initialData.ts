...
export const INITIAL_SETTINGS: AppSettings = {
  ...
  subtitleBn: 'পশ্চিমবঙ্গ পর্ষদ মক টেস্ট পোর্টাল',
  ...
  contactNumber: '+91 73844 91269',
  contactPhone: '+91 73844 91269',
  whatsappNumber: '+917384491269',
  email: 'contact@easylearnwb.org',
  website: 'https://easytolearn.wb.edu',
  ...
  examInstructionsBn: [
    'সব প্রশ্নের উত্তর দেওয়া বাধ্যতামূলক।',
    'প্রতিটি প্রশ্নের জন্য সঠিক উত্তরের গোল চিহ্নিত অথবা অপশন নির্বাচন করুন।',
    'অনলাইন পরীক্ষায় সময় শেষ হলে পরীক্ষাটি স্বয়ংক্রিয়ভাবে জমা হয়ে যাবে।',
    'পরীক্ষা চলাকালীন অন্য কোনো ট্যাব বা উইন্ডোতে যাবেন না।',
    'অসদুপায় অবলম্বন করলে পরীক্ষা বাতিল বলে গণ্য হবে।',
  ],
};
...
B = Bracket, O = Of (এর), D = Division (ভাগ), M = Multiplication (গুণ), A = Addition (যোগ), S = Subtraction (বিয়োগ).`,
  ...
  },
  {
    ...
    format: 'pdf',
    description: 'Curated list of 5 high-probability geometry theorems, riders, and constructions by Milton Sir.',
    totalPages: 1,
